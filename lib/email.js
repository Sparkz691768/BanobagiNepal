...
// User-supplied values (e.g. name) must be escaped before going into email HTML
  ...
  await transporter.sendMail({
    ...
    html: `
      <div style="font-family:Inter,sans-serif;max-width:480px;margin:0 auto;padding:32px 24px;background:#FAF9F7;border:1px solid #e5e7eb;">
        ...
        <p style="color:#2C3E50;font-size:14px;margin:0 0 8px;">Hi${name ? ' ' + escapeHtml(name) : ''},</p>
